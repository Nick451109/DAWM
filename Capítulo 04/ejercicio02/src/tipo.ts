//para transpilar un archivo y especificar su ruta de salida 
//npx tsc src/tipo.ts --strict --outDir build
//para transpilar todos los archivos
//npx tsc --strict
let valorStr = "55"
let valorInt = 55
...
function comparandoEnteros()
{
	...
	//Convierte (parsea) la cadena de texto a entero con la función c
